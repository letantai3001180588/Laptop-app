  ...
  return (
    <>
      <Stack.Screen options={{
        headerTitle: "Đăng kí", headerLeft: () => (
      ...
      <View style={styles.container}>
        ...
        <InputField placeholder='Mật khẩu' placeholderTextColor={Colors.gray} secureTextEntry={true} />
        <InputField placeholder='Xác nhận mật khẩu' placeholderTextColor={Colors.gray} secureTextEntry={true} />
